...
function handleLogout(req, res){
  ...
  res.end(pug.renderFile('./views/logout.pug', { currentTheme, user: req.user }));
}
...
function handleNotFound(req, res){
  ...
  res.end(pug.renderFile('./views/404.pug', { currentTheme, user: req.user }));
}
...
function handleTopPage(req, res){
  ...
  res.end(pug.renderFile('./views/toppage.pug', { currentTheme, user: req.user }));
}
